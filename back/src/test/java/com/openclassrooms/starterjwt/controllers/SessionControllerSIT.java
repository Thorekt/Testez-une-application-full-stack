...
public class SessionControllerSIT {
    ...
    public void givenSessionController_whenUpdate_thenReturnsUpdatedSession() throws Exception {
        ...
        Long id = 5L;
        Date date = new Date();
        Session updated = Session.builder().id(id).name("Updated Session").date(date).description("Updated").build();
    ...
    public void givenSessionController_whenParticipate_thenReturnOk() throws Exception {
        ...
        com.openclassrooms.starterjwt.models.User user = com.openclassrooms.starterjwt.models.User.builder().id(userId)
